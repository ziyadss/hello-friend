...
function save() {
    ...
    const ROOT_FOLDER = new RegExp(document.getElementById("root_folder").value, "i");
    ...
    const COLOR_THEME = document.getElementById("color_theme").value.split(",").filter((color) => color);
    const MAX_NAME_LENGTH = parseInt(document.getElementById("max_name_length").value);
